...
const Travelers = () => {
    ...
    const currentPosts = travels.slice(indexOfFirstPost, indexOfLastPost);
    ...
    return (
        <section className="text-gray-600">
            <div className='flex justify-center'>
                <h1 className=' text-3xl  text-center pt-4  font-bold border-b mb-3  '>Top Travels </h1>
            </div>
