        ...
        <footer className=" text-left bg-gray-100 text-gray-600">
          ...
          ">
                        ...
                        <p className=' text-justify'>
                            ...
                            backpacktraveler@example.com For any other enquiries please use the form below. ?
                        </p>
                    </div>
                    <div className="">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">List</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Single Slider</a>
                        </p>
                        <p>
                            <a href="#!" className="text-gray-600">Single Gallery</a>
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Provence</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Madeira</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Andalusia</a>
                        </p>
                        <p>
